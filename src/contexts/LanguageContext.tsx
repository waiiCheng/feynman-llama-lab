...
const translations = {
  zh: {
    ...
    'annotation.finalAnswer': '最终答案 (Final Answer)',
     'annotation.feynmanMethod': '费曼方法',
     'annotation.feynman.coreConcept': '核心概念',
     'annotation.feynman.coreConcept.placeholder': '您想要解释的主要概念是什么？',
     'annotation.feynman.analogy': '类比',
     'annotation.feynman.analogy.domain': '领域',
     'annotation.feynman.analogy.domain.placeholder': '日常生活、运动、烹饪等',
     'annotation.feynman.analogy.scenario': '场景',
     'annotation.feynman.analogy.scenario.placeholder': '如推箱子、煮意大利面...',
     'annotation.feynman.analogy.description': '描述',
     'annotation.feynman.analogy.description.placeholder': '详细说明这个类比...',
     'annotation.feynman.breakdown': '逐步分解',
     'annotation.feynman.breakdown.add': '添加步骤',
     'annotation.feynman.breakdown.step': '步骤',
     'annotation.feynman.breakdown.remove': '删除',
     'annotation.feynman.breakdown.explanation': '解释',
     'annotation.feynman.breakdown.explanation.placeholder': '清楚地解释这个步骤...',
     'annotation.feynman.breakdown.linkedConcept': '相关概念',
     'annotation.feynman.breakdown.linkedConcept.placeholder': '这与什么概念相关？',
     'annotation.feynman.summary': '总结',
     'annotation.feynman.summary.placeholder': '总结完整的解释...',
    ...
    'annotation.finalAnswer.placeholder': '请输入问题的最终答案...',
    'annotation.feynmanMethod.placeholder': '在此输入费曼方法的JSON格式...',
    'annotation.quality.placeholder': '选择质量等级',
    'annotation.notes.placeholder': '其他备注信息...',
    'annotation.validation.title': '请填写必要字段',
    'annotation.validation.desc': '问题和最终答案都是必填项',
    'annotation.validation.jsonError': '错误: 费曼方法中的JSON格式不正确，请检查！',
  ...
  en: {
    ...
    'annotation.finalAnswer': 'Final Answer',
     'annotation.feynmanMethod': 'Feynman Method',
     'annotation.feynman.coreConcept': 'Core Concept',
     'annotation.feynman.coreConcept.placeholder': 'What is the main concept you want to explain?',
     'annotation.feynman.analogy': 'Analogy',
     'annotation.feynman.analogy.domain': 'Domain',
     'annotation.feynman.analogy.domain.placeholder': 'Daily life, sports, cooking, etc.',
     'annotation.feynman.analogy.scenario': 'Scenario',
     'annotation.feynman.analogy.scenario.placeholder': 'Like pushing boxes, cooking pasta...',
     'annotation.feynman.analogy.description': 'Description',
     'annotation.feynman.analogy.description.placeholder': 'Detailed explanation of the analogy...',
     'annotation.feynman.breakdown': 'Step-by-Step Breakdown',
     'annotation.feynman.breakdown.add': 'Add Step',
     'annotation.feynman.breakdown.step': 'Step',
     'annotation.feynman.breakdown.remove': 'Remove',
     'annotation.feynman.breakdown.explanation': 'Explanation',
     'annotation.feynman.breakdown.explanation.placeholder': 'Explain this step clearly...',
     'annotation.feynman.breakdown.linkedConcept': 'Related Concept',
     'annotation.feynman.breakdown.linkedConcept.placeholder': 'What concept does this relate to?',
     'annotation.feynman.summary': 'Summary',
     'annotation.feynman.summary.placeholder': 'Summarize the complete explanation...',
    ...
    'annotation.finalAnswer.placeholder': 'Enter the final answer to the question...',
    'annotation.feynmanMethod.placeholder': 'Enter Feynman method in JSON format here...',
    ...
    'annotation.validation.desc': 'Question and final answer are required',
    'annotation.validation.jsonError': 'Error: JSON format in "Feynman Method" is incorrect, please check!',
